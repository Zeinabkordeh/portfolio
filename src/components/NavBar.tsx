...
//                     block.svg.text = block.svg.group.text(0, 0, block.title).attr({
//                         textpath: block.svg.textpath,
//                         mask: block.svg.mask,
//                     });
//                 }
...
//                     var newPath = this.getPathOffset(
//                         path2.slice(startX + textPaddingX, endX - textPaddingX),
//                         -textPaddingY,
//                         -textPaddingY
//                     );
//                     if (newPath.length > 2) {
...
//         var mapped = points.map((d: any[]) => d.join(','));
...
//                 this.blocks[i].position.target =
//                     this.blocks[i].position.current < selectedBlockPosition
//                         ? tempHome - 100
//                         : tempHome + 100;
//             }
//         }
